...
def load_ckpt(trainer, last=False):
    ...
    # 直接用last.pt  因为报错[Errno 2] 没有那个文件或目录: '/home/aita130/drug_discovery/ldm/fragment-based-dgm-master/RUNS/2023-06-25@11:13:09 PM-aita130-Z490-UD-ZINC/ckpt/best_valid.pt
    path = trainer.config.path('ckpt') / filename
...
class Trainer:
    ...
    def _train_epoch(self, epoch, loader,config,dataloader):
        ...
        # df1=df1["smiles"]
        # # loaderss = DataLoader(dataset=df1,
        # #                     batch_size=self.config.get('batch_size'),
        # #                     num_workers=24,
        # #                     shuffle=False)
        # # print(len(loader),len(loaderss))
